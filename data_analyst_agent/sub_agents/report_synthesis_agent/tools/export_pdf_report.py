...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python -m data_analyst_agent.sub_agents.report_synthesis_agent.tools.export_pdf_report <markdown_file> [output_pdf]")
        print("\nExamples:")
        print("  python -m data_analyst_agent.sub_agents.report_synthesis_agent.tools.export_pdf_report outputs/metric_Truck_Count.md")
        print("  python -m data_analyst_agent.sub_agents.report_synthesis_agent.tools.export_pdf_report outputs/metric_Truck_Count.md outputs/report.pdf")
        sys.exit(1)

...
- **Impact**: Based on $ variance and % of primary_metric
...
- `get_supplementary_data_for_period()` - Order-level operational details
- `get_top_entities_by_metric()` - Entity analysis
- `get_period_aggregates_by_dimension()` - Monthly operational aggregates

    ...
    return {
        ...
        "body": {
            "sections": [
                ...
                {"title": "Key Findings", "content": "All key performance indicators remained within expected statistical bounds, aligning with historical trends.", "insights": insights},

...
def setup_google_auth():
    ...
    if "GOOGLE_APPLICATION_CREDENTIALS" in os.environ:
        ...
        if Path(creds_path).exists():
            # If we have a service account, disable API key to avoid conflicts
    ...
    json_file = project_root.parent / "service-account.json"
    if json_file.exists():
        ...
        return ("service_account_file_root", "project root")

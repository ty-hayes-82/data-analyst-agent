...
def calculate_date_ranges() -> Dict[str, str]:
    ...
    return {
        "pl_query_start_date": pl_start,
        "pl_query_end_date": current_date,
        "ops_metrics_query_start_date": pl_start,
        "ops_metrics_query_end_date": current_date,
        "order_query_start_date": order_start,
        "order_query_end_date": current_date,
    }

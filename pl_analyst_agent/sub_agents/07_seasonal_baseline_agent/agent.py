...
from .tools import compute_seasonal_decomposition
...
root_agent = SequentialAgent(
    ...
    description="Seasonal analysis: Decomposes time series to identify TRUE anomalies after removing seasonal patterns"
)

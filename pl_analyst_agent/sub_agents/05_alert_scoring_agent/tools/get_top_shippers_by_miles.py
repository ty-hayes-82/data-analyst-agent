...
async def get_top_shippers_by_miles(
    start_date: str,
    end_date: str,
    cost_center: str,
    top_n: int = 10
) -> str:
    """Get top shippers ranked by total loaded miles for a specific period and cost center.
    ...
    Example:
        # Get top 10 shippers for June 2025 at cost center 497
        get_top_shippers_by_miles("2025-06-01", "2025-06-30", "497", top_n=10)
    """
    try:
        ...
        output_file = output_dir / f"top_shippers_{cost_center}_{start_date}_{end_date}.json"

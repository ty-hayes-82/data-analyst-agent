...
"""
 Llm Extract Alerts From Text tool for alert_scoring_coordinator_agent.
"""
...
async def _llm_extract_alerts_from_text(
    ...
    prompt = f"""You are an expert financial analyst. Extract anomaly alerts from these analysis results for cost center {cost_center}.
...
def _extract_alerts_from_text(text: str, cost_center: str, validated_data: Any, cv: float, history_count: int) -> list:
